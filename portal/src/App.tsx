...
import {
  ...
  Wifi, Settings, ChevronLeft, ChevronRight, Zap, Activity,
  Building2, MapPin, Terminal, CreditCard, HardDrive
} from 'lucide-react'
  ...
  return (
    <header className="h-14 bg-white border-b border-surface-3 px-6 flex items-center justify-between sticky top-0 z-10">
      ...
      <div className="flex items-center gap-3">
        <a href="http://localhost:3020" target="_blank" rel="noopener"
