...
billing_control_center_menu_item = PluginMenuItem(
    link='plugins:netbox_contract:billing_control_center',
    link_text=_('Billing Control Center'),
    permissions=['netbox_contract.view_contract'],
)
...
items = (
    ...
    billing_control_center_menu_item,
