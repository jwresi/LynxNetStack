...
from mcp.routeros_routing_catalog import ROUTEROS_ROUTING_SCENARIOS  # noqa: E402
...
TOOLS = [
    {
        ...
        "description": "Return RouterOS routing MCP status and batch scope.",
        "inputSchema": {"type": "object", "properties": {}},
    }
]

for tool_name, scenario in ROUTEROS_ROUTING_SCENARIOS.items():
    TOOLS.append(
        {
            "name": tool_name,
...
def build_scenario_result(tool_name: str, arguments: dict[str, Any]) -> dict[str, Any]:
    scenario = dict(ROUTEROS_ROUTING_SCENARIOS[tool_name])
...
class RouterOsRouting:
    def get_server_info(self) -> dict[str, Any]:
        return {
            "name": "routeros-routing-mcp",
            "version": "0.1.0",
            "intent_group": "routing_control_plane",
            "tool_count": len(TOOLS),
            "scenario_count": len(ROUTEROS_ROUTING_SCENARIOS),
            "scenarios": list(ROUTEROS_ROUTING_SCENARIOS.keys()),
        }


class Server:
    def __init__(self) -> None:
        self.impl = RouterOsRouting()
    ...
    def handle(self, req: dict[str, Any]) -> dict[str, Any] | None:
        ...
        if method == "initialize":
            return {
                ...
                "result": {
                    ...
                    "serverInfo": {"name": "routeros-routing-mcp", "version": "0.1.0"},
                },
            }
        ...
        if method == "tools/call":
            ...
            elif name in ROUTEROS_ROUTING_SCENARIOS:
