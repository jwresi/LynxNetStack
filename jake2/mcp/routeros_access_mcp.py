...
from mcp.routeros_access_catalog import ROUTEROS_ACCESS_SCENARIOS  # noqa: E402
...
TOOLS = [
    {
        ...
        "description": "Return RouterOS access MCP status and batch scope.",
        "inputSchema": {"type": "object", "properties": {}},
    }
]

for tool_name, scenario in ROUTEROS_ACCESS_SCENARIOS.items():
    TOOLS.append(
        {
            "name": tool_name,
...
def build_scenario_result(tool_name: str, arguments: dict[str, Any]) -> dict[str, Any]:
    scenario = dict(ROUTEROS_ACCESS_SCENARIOS[tool_name])
    observed = {
    ...
    scenario["observed_context"] = observed
    return scenario


class RouterOsAccess:
    def get_server_info(self) -> dict[str, Any]:
        return {
            "name": "routeros-access-mcp",
            "version": "0.1.0",
            "intent_group": "subscriber_access",
            "tool_count": len(TOOLS),
            "scenario_count": len(ROUTEROS_ACCESS_SCENARIOS),
            "scenarios": list(ROUTEROS_ACCESS_SCENARIOS.keys()),
        }


class Server:
    def __init__(self) -> None:
        self.impl = RouterOsAccess()
    ...
    def handle(self, req: dict[str, Any]) -> dict[str, Any] | None:
        ...
        if method == "initialize":
            return {
                ...
                "result": {
                    ...
                    "serverInfo": {"name": "routeros-access-mcp", "version": "0.1.0"},
                },
            }
        ...
        if method == "tools/call":
            ...
            elif name in ROUTEROS_ACCESS_SCENARIOS:
