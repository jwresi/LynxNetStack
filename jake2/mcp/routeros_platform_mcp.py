...
from mcp.routeros_platform_catalog import ROUTEROS_PLATFORM_SCENARIOS  # noqa: E402
...
TOOLS = [
    {
        ...
        "description": "Return RouterOS platform MCP status and batch scope.",
        "inputSchema": {"type": "object", "properties": {}},
    }
]

for tool_name, scenario in ROUTEROS_PLATFORM_SCENARIOS.items():
    TOOLS.append(
        {
            "name": tool_name,
...
def build_scenario_result(tool_name: str, arguments: dict[str, Any]) -> dict[str, Any]:
    scenario = dict(ROUTEROS_PLATFORM_SCENARIOS[tool_name])
...
class RouterOsPlatform:
    def get_server_info(self) -> dict[str, Any]:
        return {
            "name": "routeros-platform-mcp",
            "version": "0.1.0",
            "intent_group": "platform_hardware",
            "tool_count": len(TOOLS),
            "scenario_count": len(ROUTEROS_PLATFORM_SCENARIOS),
            "scenarios": list(ROUTEROS_PLATFORM_SCENARIOS.keys()),
        }


class Server:
    def __init__(self) -> None:
        self.impl = RouterOsPlatform()
    ...
    def handle(self, req: dict[str, Any]) -> dict[str, Any] | None:
        ...
        if method == "initialize":
            return {
                ...
                "result": {
                    ...
                    "serverInfo": {"name": "routeros-platform-mcp", "version": "0.1.0"},
                },
            }
        ...
        if method == "tools/call":
            ...
            elif name in ROUTEROS_PLATFORM_SCENARIOS:
